...
function IletisimBilgileri(){
  function iletisimbilgigonder(){
    var iletisimbilgi =[(document.getElementById("telefon_no").value), (document.getElementById("ulke").value),(document.getElementById("sehir").value),(document.getElementById("adres").value)];
        sessionStorage.setItem("iletisimbilgi", iletisimbilgi);
    }
    return(
        <div class="row">
        <div class="col-3" >
            ...
            <div class="col-8">
              ...
              <div class="row g-3 mb-3">
                <div class="col">
                  ...
                  <input type="text" class="form-control" id="telefon_no" placeholder="" aria-label=""/>
                </div>
                <div class="col ">
      ...
      <option value="Yunanistan">Yunanistan</option>
              ...
              <div class="row g-3 mb-3">
                <div class="col">
                  ...
                  <input type="text" class="form-control" id="sehir" placeholder="" aria-label=""/>
                </div>
                <div class="col ">
                    <label for="exampleFormControlInput1" class="form-label">Adres</label>
                  <input type="text" class="form-control" id="adres" placeholder="" aria-label=""/>
                </div>
              </div>
              
              
              <div class="mb-3 " style={{marginLeft:"150px"}}>
                <Link to="/portal/DokumanYukleme"><button type="button" class="btn btn-primary btn-lg btn-block" onClick={iletisimbilgigonder} >İlerle</button></Link>
